...
//    cQuery += "       Sum(TMP1.Z4_DINHEIR) as DINHEIRO,  Sum(TMP1.Z4_DEBITO) as DEBITO, Sum(TMP1.Z4_CHEQUE) as CHEQUE"
    cQuery += "       TMP1.Z4_DINHEIR as DINHEIRO, TMP1.Z4_DEBITO as DEBITO, TMP1.Z4_CHEQUE as CHEQUE"
    cQuery += "  from (Select TMP.Z4_OPERADO, TMP.Z4_SEQ, TMP.Z4_CHEQUE, TMP.Z4_DINHEIR, TMP.Z4_DEBITO, Sum(a.Z4_VLPAGTO) as TOTAL" 
    cQuery += "        	from (Select Distinct SZ4.Z4_FILIAL, SZ4.Z4_DATA, SZ4.Z4_OPERADO,"
    cQuery += "                       SZ4.Z4_SEQ, SZ4.Z4_CHEQUE, SZ4.Z4_DINHEIR, SZ4.Z4_DEBITO"
    ...
    cQuery += "          Group by TMP.Z4_OPERADO, TMP.Z4_SEQ, TMP.Z4_CHEQUE, TMP.Z4_DINHEIR, TMP.Z4_DEBITO) TMP1"
    cQuery += "  Group by TMP1.Z4_OPERADO, TMP1.Z4_SEQ, TMP1.Z4_DINHEIR, TMP1.Z4_DEBITO, TMP1.Z4_CHEQUE"
