...
User Function RIOP9000(cEmp,cFil,cPDV)
	...
	FwLogMsg("INFO",,"INTEGRATION",FunName(),"","01","*** (1) INICIO ENVIO PAGAMENTO DE FATURA - RETAGUARDA (SZ4) ***",0,(nStart - Seconds()),{})
	...
	While ! SZ4->(Eof()) .and. SZ4->Z4_TRANRET == "N"
		...
		aRet := U_RIOF9002("SZ4",cEnvSoap)    // Levar o Pagamento Cartão pra retaguarda
